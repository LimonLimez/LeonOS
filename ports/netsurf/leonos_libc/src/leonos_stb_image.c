 ...
 * MIME sniffing, layout, and redraw. stb_image decodes PNG/JPEG bytes into
 * NetSurf's normal 32-bit RGBA bitmap format; ICO remains handled by
 * NetSurf/libnsbmp so paletted and masked favicons work.
 */
