...
static void qjs_maybe_run_selector_selftest(JSContext *ctx)
{
	...
	static const char selftest[] =
		...
		"repl.className='mix-repl';doomed.id='mix-doomed';wrapChild.className='replace-child';"
		...
		"typeof wrap.replaceChildren==='function'&&mix.querySelectorAll('i.mix-before + b#mix-target').length===1&&"
		"mix.querySelectorAll('b#mix-target + small.mix-repl').length===1&&"
