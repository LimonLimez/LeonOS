 ...
 *
 * This is not a libc, socket layer, or complete browser port. It is the first
 * callable surface that lets freestanding i386 user code query and draw to the
 * LeonOS framebuffer without receiving kernel function pointers.
 */
