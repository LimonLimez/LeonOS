...
static u8 tss_kernel_stack[8192] __attribute__((aligned(16)));
...
static u8 net_ready;
static u8 net_mac[6];
static u8 net_ip[4] = { 10u, 0u, 2u, 15u };
static u8 net_gateway_ip[4] = { 10u, 0u, 2u, 2u };
static u8 net_dns_ip[4] = { 10u, 0u, 2u, 3u };
